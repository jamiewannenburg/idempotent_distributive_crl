...
if __name__ == "__main__":
    ...
    parser.add_argument("-d","--difficult", type=str, default="difficult-7.txt")
    parser.add_argument("-i","--input", type=str, default="rsi_icrp-7.model")
    parser.add_argument("-o","--output", type=str, default="rsi_icrp-7_difficult.pdf")
